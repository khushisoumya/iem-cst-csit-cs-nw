  ...
  return (
    <section className="bg-gray-50 pt-10 pb-20">
      <div className="max-w-5xl mx-auto px-6">
        <div className="group relative overflow-hidden rounded-2xl bg-white border border-gray-200 shadow-[0_10px_30px_rgba(8,31,92,0.08)] hover:shadow-[0_25px_50px_rgba(8,31,92,0.18)] transition-shadow duration-500">
          ...
          <div className="p-8 md:p-10 flex flex-col md:flex-row gap-10">
            ...
            <div className="flex-1">
              ...
              <div className="mt-6 relative pl-6 border-l-2 border-navy/20">
                <Quote className="absolute -left-3 -top-1 text-navy/20" size={20} fill="currentColor" />
                <p className="italic text-lg leading-8 text-navy">
              ...
              <button
                ...
                className="mt-7 inline-flex items-center gap-2 font-semibold text-navy bg-navy/5 hover:bg-navy hover:text-white px-4 py-2 rounded-full transition-all duration-300"
              >
